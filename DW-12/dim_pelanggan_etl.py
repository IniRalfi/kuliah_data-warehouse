...
def load_dim_pelanggan(df: pd.DataFrame):
    ...
    try:
        ...
        print(
            f"Berhasil memuat {len(df)} baris data pelanggan ke tabel 'dim_pelanggan' di DW PostgreSQL."
        )
    except Exception as e:
...
@flow(
    name="ETL Flow: Dimensi Pelanggan",
    description="Pipeline khusus untuk mengisi dim_pelanggan dari tb_customers",
)
